...
tmux set -g status-right "#[fg=$TMUX_COLOR_LIGHT_GRAY,bg=$TMUX_COLOR_DARK_GRAY,nobold,nounderscore,noitalics]#[fg=$TMUX_COLOR_WHITE,bg=$TMUX_COLOR_LIGHT_GRAY] %Y-%m-%d | %H:%M #[fg=$TMUX_COLOR_WHITE,bg=$TMUX_COLOR_LIGHT_GRAY,nobold,nounderscore,noitalics]#[fg=$TMUX_COLOR_BLACK,bg=$TMUX_COLOR_WHITE] #h "
tmux setw -g window-status-format "#[fg=$TMUX_COLOR_WHITE,bg=$TMUX_COLOR_DARK_GRAY] #I:#W "
