...
TMUX_COLOR_STATUS="${TMUX_COLOR_PURPLE}"
...
tmux setenv -g "TMUX_COLOR_STATUS" "${TMUX_COLOR_STATUS}"
...
tmux set -g pane-active-border-style "fg=${TMUX_COLOR_STATUS}"
...
tmux set -g status-left "#[fg=${TMUX_COLOR_BG},bg=${TMUX_COLOR_STATUS},bold] #S "
tmux set -g status-right "#[fg=${TMUX_COLOR_STATUS}]#{?client_prefix,P,} #(~/.config/tmux/network.sh) #(~/.config/tmux/memory.sh) #(~/.config/tmux/cpu.sh) #[fg=${TMUX_COLOR_BG},bg=${TMUX_COLOR_STATUS},bold] #h "
