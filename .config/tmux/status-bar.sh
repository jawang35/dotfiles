...
tmux set -g status-left "#[fg=$TMUX_COLOR_BLACK,bg=$TMUX_COLOR_PURPLE] #S #[default] #($HOME/.config/tmux/mem-cpu.py '$TMUX_COLOR_GREEN' '$TMUX_COLOR_YELLOW' '$TMUX_COLOR_RED')"
tmux set -g status-right "#[fg=$TMUX_COLOR_PURPLE]  %b %d  %H:%M #[fg=$TMUX_COLOR_BLACK,bg=$TMUX_COLOR_PURPLE] #h "
